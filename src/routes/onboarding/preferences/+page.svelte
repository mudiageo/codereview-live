			...
			<div class="space-y-3">
				...
				<RadioGroup bind:value={theme} class="grid grid-cols-3 gap-4">
					...
					<div>
						...
						>
							<div
								class="mb-2 h-12 w-12 rounded-md bg-gradient-to-br from-white to-slate-950 border"
							></div>
			...
			<div class="space-y-4">
				...
				<div class="flex items-center justify-between">
					<div class="space-y-0.5">
						...
						<p class="text-sm text-muted-foreground">Automatically sync reviews to cloud</p>
					</div>
