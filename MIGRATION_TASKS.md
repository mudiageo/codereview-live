...
- [ ] `src/lib/components/ai-analysis-panel.svelte`
- [ ] `src/lib/components/auth-guard.svelte`
- [ ] `src/lib/components/github-import-dialog.svelte`
- [ ] `src/lib/components/search-command.svelte`
- [ ] `src/lib/components/ui/notifications-dropdown.svelte`
...
- [ ] `src/routes/api/github/token/+server.ts`
- [ ] `src/routes/api/paystack/initialize/+server.ts`
- [ ] `src/routes/api/paystack/webhook/+server.ts`
